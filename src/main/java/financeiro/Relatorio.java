...
/**
 *Classe responsável por gerar diferentes tipos de relatórios financeiros.
 * Ela utiliza os gerenciadores {@link GerenciadorVenda} e {@link GerenciadorDespesas}
 * para acessar as listas de vendas e despesas registradas.
...
public class Relatorio {
    ...
    /**
     * Constrói um novo objeto Relatorio a partir dos gerenciadores de vendas e despesas.
     *
     * @param gv gerenciador responsável pelas vendas
     * @param gd gerenciador responsável pelas despesas
     */
    ...
    /**
     * Gera e exibe no console o balanço mensal de um determinado mês e ano.
     * <p>
     * O balanço inclui:
     * - total de vendas do período,
     * - total de despesas do período,
     * - lucro, prejuízo ou resultado neutro.
     *
    ...
    public void gerarBalancoMensal(int ano, int mes) {
        ...
        if (saldo > 0) {
            System.out.printf("Lucro do mês: R$ %.2f%n", saldo);
        } else if (saldo < 0) {
            System.out.printf("Prejuízo do mês: R$ %.2f%n", Math.abs(saldo));
        } else {
    ...
    /**
     * Gera e exibe no console todas as despesas registradas
    ...
    /**
     * Gera e exibe no console todas as vendas realizadas
     * em um determinado mês e ano.
     *
     * @param ano o ano desejado
     * @param mes o mês desejado (1-12)
